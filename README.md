...
This project is a basic Windows application written in C. The application demonstrates the creation of a simple window using the Win32 API.

## Files

- `Main.c`: Contains the C code for the main application logic, including the window procedure and entry point.
